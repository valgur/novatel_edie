...
function(find_or_download_conan)
    ...
    if(CONAN_EXECUTABLE)
        ...
        # Isolate the Conan cache to not pollute the user's home directory unexpectedly
        message(STATUS "Using ${ARG_DESTINATION} as $CONAN_HOME")
        set(ENV{CONAN_HOME} "${ARG_DESTINATION}")
    endif()
endfunction()
