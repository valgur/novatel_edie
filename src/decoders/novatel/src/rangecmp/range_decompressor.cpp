...
static std::map<SYSTEM, std::map<RangeCmp2::SIGNAL_TYPE, const double>> mmTheRangeCmp2SignalScalingMapping =
{
   ...
   },
   {
      SYSTEM::SBAS,
      {
         {RangeCmp2::SIGNAL_TYPE::SBAS_L1CA, (1.0)},
         {RangeCmp2::SIGNAL_TYPE::SBAS_L5I, (154.0/115.0)}
      }
   },
   {
      SYSTEM::GALILEO,
   ...
   },
   {
      SYSTEM::LBAND,
      {
         {RangeCmp2::SIGNAL_TYPE::LBAND, (1.0)}
      }
   },
   {
      SYSTEM::NAVIC,
      {
         {RangeCmp2::SIGNAL_TYPE::NAVIC_L5SPS, (1.0)}
      }
   }
};
...
{
   {
      SYSTEM::GPS,
      {
         RangeCmp4::SIGNAL_TYPE::GPS_L1CA,
         RangeCmp4::SIGNAL_TYPE::GPS_L2Y,
         RangeCmp4::SIGNAL_TYPE::GPS_L2C,
         RangeCmp4::SIGNAL_TYPE::GPS_L2P,
         RangeCmp4::SIGNAL_TYPE::GPS_L5Q,
         RangeCmp4::SIGNAL_TYPE::GPS_L1C
      }
   },
   {
      SYSTEM::GLONASS,
      {
         ...
         RangeCmp4::SIGNAL_TYPE::GLONASS_L1CA,
         RangeCmp4::SIGNAL_TYPE::GLONASS_L2CA,
         RangeCmp4::SIGNAL_TYPE::GLONASS_L2P,
   ...
   },
   {
      SYSTEM::SBAS,
      {
         RangeCmp4::SIGNAL_TYPE::SBAS_L1CA,
         RangeCmp4::SIGNAL_TYPE::SBAS_L5I
      }
   },
   {
      SYSTEM::GALILEO,
      {
         RangeCmp4::SIGNAL_TYPE::GALILEO_E1,
         RangeCmp4::SIGNAL_TYPE::GALILEO_E5A,
         RangeCmp4::SIGNAL_TYPE::GALILEO_E5B,
         RangeCmp4::SIGNAL_TYPE::GALILEO_ALTBOC,
         RangeCmp4::SIGNAL_TYPE::GALILEO_E6C,
         RangeCmp4::SIGNAL_TYPE::GALILEO_E6B
      }
   },
   {
      SYSTEM::BEIDOU,
      {
         RangeCmp4::SIGNAL_TYPE::BEIDOU_B1I,
         RangeCmp4::SIGNAL_TYPE::BEIDOU_B1GEO,
         RangeCmp4::SIGNAL_TYPE::BEIDOU_B2I,
         RangeCmp4::SIGNAL_TYPE::BEIDOU_B2GEO,
         RangeCmp4::SIGNAL_TYPE::BEIDOU_B3I,
         RangeCmp4::SIGNAL_TYPE::BEIDOU_B3GEO,
         RangeCmp4::SIGNAL_TYPE::BEIDOU_B1CP,
         RangeCmp4::SIGNAL_TYPE::BEIDOU_B2AP,
         RangeCmp4::SIGNAL_TYPE::BEIDOU_B2BI
      }
   },
   {
      SYSTEM::QZSS,
      {
         RangeCmp4::SIGNAL_TYPE::QZSS_L1CA,
         RangeCmp4::SIGNAL_TYPE::QZSS_L2C,
         RangeCmp4::SIGNAL_TYPE::QZSS_L5Q,
         RangeCmp4::SIGNAL_TYPE::QZSS_L1C,
         RangeCmp4::SIGNAL_TYPE::QZSS_L6D,
   ...
   },
   {
      SYSTEM::NAVIC,
      {
         RangeCmp4::SIGNAL_TYPE::NAVIC_L5SPS
      }
   }
};
...
// -------------------------------------------------------------------------------------------------------
void
RangeDecompressor::SetLoggerLevel(spdlog::level::level_enum eLevel_)
{
...
// -------------------------------------------------------------------------------------------------------
void
RangeDecompressor::ShutdownLogger()
{
   Logger::Shutdown();
}
...
//------------------------------------------------------------------------------
double
RangeDecompressor::GetSignalWavelength(const ChannelTrackingStatusStruct& stChannelTrackingStatus_, int16_t sGLONASSFrequency_)
{
   ...
   case ChannelTrackingStatusStruct::SATELLITE_SYSTEM::GLONASS:
      return stChannelTrackingStatus_.eSignalType == ChannelTrackingStatusStruct::SIGNAL_TYPE::GLONASS_L1CA ? SPEED_OF_LIGHT / (FREQUENCY_HZ_GLO_L1 + (sGLONASSFrequency_ * GLONASS_L1_FREQUENCY_SCALE_HZ))
           : stChannelTrackingStatus_.eSignalType == ChannelTrackingStatusStruct::SIGNAL_TYPE::GLONASS_L2CA ? SPEED_OF_LIGHT / (FREQUENCY_HZ_GLO_L2 + (sGLONASSFrequency_ * GLONASS_L2_FREQUENCY_SCALE_HZ))
           : stChannelTrackingStatus_.eSignalType == ChannelTrackingStatusStruct::SIGNAL_TYPE::GLONASS_L2P  ? SPEED_OF_LIGHT / (FREQUENCY_HZ_GLO_L2 + (sGLONASSFrequency_ * GLONASS_L2_FREQUENCY_SCALE_HZ))
   ...
   case ChannelTrackingStatusStruct::SATELLITE_SYSTEM::NAVIC:
      return stChannelTrackingStatus_.eSignalType == ChannelTrackingStatusStruct::SIGNAL_TYPE::NAVIC_L5SPS ? WAVELENGTH_NAVIC_L5
           : 0.0;
   default:
      return 0.0;
   }
...
//------------------------------------------------------------------------------
uint64_t
RangeDecompressor::GetBitfieldFromBuffer(uint8_t** ppucDataBuffer_, uint32_t uiBitsInBitfield_)
{
   ...
   {
      if (ucCurrentByte & (1UL << uiMyBitOffset))
      {
         ulBitfield |= (1ULL << uiBitsConsumed);
      }
...
//------------------------------------------------------------------------------
float
RangeDecompressor::DetermineRangeCmp2ObservationLocktime(const MetaDataStruct& stMetaData_, uint32_t uiLocktimeBits_, ChannelTrackingStatusStruct::SATELLITE_SYSTEM eSystem_, ChannelTrackingStatusStruct::SIGNAL_TYPE eSignal_, uint16_t usPRN_)
{
   float fLocktimeMilliseconds = static_cast<float>(uiLocktimeBits_);

   RangeCmp2LocktimeInfoStruct& stLocktimeInfo = ammmMyRangeCmp2Locktimes[static_cast<uint32_t>(stMetaData_.eMeasurementSource)][eSystem_][eSignal_][static_cast<uint32_t>(usPRN_)];
   if (uiLocktimeBits_ == (RC2_SIG_LOCKTIME_MASK >> RC2_SIG_LOCKTIME_SHIFT))
   {
      ...
      else // If the locktime is not already saturated, store this information if this observation is seen again.
      {
         stLocktimeInfo.dLocktimeSaturatedMilliseconds = stMetaData_.dMilliseconds;
         stLocktimeInfo.bLocktimeSaturated = true;
      }
   }
   else if (stLocktimeInfo.bLocktimeSaturated) // If the locktime marked as saturated, but is not reported as such from the RANGECMP2 message, clear the flag.
   {
...
//------------------------------------------------------------------------------
float
RangeDecompressor::DetermineRangeCmp4ObservationLocktime(const MetaDataStruct& stMetaData_, uint8_t ucLocktimeBits_, ChannelTrackingStatusStruct::SATELLITE_SYSTEM eSystem_, ChannelTrackingStatusStruct::SIGNAL_TYPE eSignal_, uint32_t uiPRN_)
{
   // Store the locktime if it is different then the once we have currently.
   RangeCmp4LocktimeInfoStruct& stLocktimeInfo = ammmMyRangeCmp4Locktimes[static_cast<uint32_t>(stMetaData_.eMeasurementSource)][eSystem_][eSignal_][uiPRN_];
   ...
   if ((!stLocktimeInfo.bLocktimeAbsolute) && (ucLocktimeBits_ != stLocktimeInfo.ucLocktimeBits))
   {
      ...
      if (ucLocktimeBits_ == 0 || (stLocktimeInfo.ucLocktimeBits != 0xFF && ucLocktimeBits_ > stLocktimeInfo.ucLocktimeBits))
      {
         ...
         if (dLocktimeChangeMilliseconds != 0)
         {
            pclMyLogger->warn("Detected a locktime jump of {}ms at time {}w, {}ms. SYSTEM: {}, SIGNAL: {}, PRN: {}.",
               abs(dLocktimeChangeMilliseconds), stMetaData_.usWeek, stMetaData_.dMilliseconds,
   ...
   else if (ucLocktimeBits_ < stLocktimeInfo.ucLocktimeBits)
   {
      ...
      pclMyLogger->warn("Detected a locktime slip (perhaps caused by an outage) of {}ms at time {}w, {}ms. SYSTEM: {}, SIGNAL: {}, PRN: {}.",
         (stLocktimeInfo.dLocktimeMilliseconds - afTheRangeCmp4LockTimeValues[stLocktimeInfo.ucLocktimeBits]), stMetaData_.usWeek, stMetaData_.dMilliseconds,
         static_cast<int32_t>(eSystem_), static_cast<int32_t>(eSignal_), uiPRN_);
   }
   else
   {
      // If the locktime is absolute, and the bits have not changed after a change would be expected, reset
      // the time since last bitfield change as there may have been an outage.
   ...
   stLocktimeInfo.dLocktimeMilliseconds = (stMetaData_.dMilliseconds - stLocktimeInfo.dLastBitfieldChangeMilliseconds) + afTheRangeCmp4LockTimeValues[stLocktimeInfo.ucLocktimeBits];
...
//------------------------------------------------------------------------------
template<bool bSecondary> void
RangeDecompressor::DecompressReferenceBlock(uint8_t** ppucDataPointer_, RangeCmp4MeasurementSignalBlockStruct& stReferenceBlock_, MEASUREMENT_SOURCE eMeasurementSource_)
{
   ...
   if (bSecondary && llPSRBitfield & RC4_SSIG_RBLK_PSR_SIGNBIT_MASK)
   {
      llPSRBitfield |= RC4_SSIG_RBLK_PSR_SIGNEXT_MASK;
   }
   auto iPhaseRangeBitfield = static_cast<int32_t>(GetBitfieldFromBuffer(ppucDataPointer_, RC4_RBLK_PHASERANGE_BITS[bSecondary]));
   if (iPhaseRangeBitfield & RC4_RBLK_PHASERANGE_SIGNBIT_MASK)
   {
      iPhaseRangeBitfield |= RC4_RBLK_PHASERANGE_SIGNEXT_MASK;
   }
   auto iDopplerBitfield = static_cast<int32_t>(GetBitfieldFromBuffer(ppucDataPointer_, RC4_RBLK_DOPPLER_BITS[bSecondary]));
   if (iDopplerBitfield & RC4_RBLK_DOPPLER_SIGNBIT_MASK[bSecondary])
   {
      iDopplerBitfield |= RC4_RBLK_DOPPLER_SIGNEXT_MASK[bSecondary];
   }

   stReferenceBlock_.bValidPSR        = llPSRBitfield != RC4_RBLK_INVALID_PSR[bSecondary];
   stReferenceBlock_.dPSR             = static_cast<double>(llPSRBitfield) * RC4_SIG_BLK_PSR_SCALE_FACTOR + (bSecondary ? astMyLastPrimaryReferenceBlocks[static_cast<uint32_t>(eMeasurementSource_)].dPSR : 0);
   ...
   stReferenceBlock_.dDoppler         = static_cast<double>(iDopplerBitfield) * RC4_SIG_BLK_DOPPLER_SCALE_FACTOR + (bSecondary ? astMyLastPrimaryReferenceBlocks[static_cast<uint32_t>(eMeasurementSource_)].dDoppler : 0);

   if constexpr (!bSecondary)
   { // For subsequent blocks, we're going to need to store this primary block.
      memcpy(&astMyLastPrimaryReferenceBlocks[static_cast<uint32_t>(eMeasurementSource_)], &stReferenceBlock_, sizeof(RangeCmp4MeasurementSignalBlockStruct));
   }
}
...
//------------------------------------------------------------------------------
template<bool bIsSecondary> void
RangeDecompressor::DecompressDifferentialBlock(uint8_t** ppucDataPointer_, RangeCmp4MeasurementSignalBlockStruct& stDifferentialBlock_, const RangeCmp4MeasurementSignalBlockStruct& stReferenceBlock_, double dSecondOffset_)
{
   // These fields are the same size regardless of the reference block being primary or secondary.
   ...
   if (iPSRBitfield & RC4_SIG_DBLK_PSR_SIGNBIT_MASK)
   {
      iPSRBitfield |= RC4_SIG_DBLK_PSR_SIGNEXT_MASK;
   }
   auto iPhaseRangeBitfield = static_cast<int32_t>(GetBitfieldFromBuffer(ppucDataPointer_, RC4_SIG_DBLK_PHASERANGE_BITS));
   if (iPhaseRangeBitfield & RC4_SIG_DBLK_PHASERANGE_SIGNBIT_MASK)
   {
      iPhaseRangeBitfield |= RC4_SIG_DBLK_PHASERANGE_SIGNEXT_MASK;
   }
   auto iDopplerBitfield = static_cast<int32_t>(GetBitfieldFromBuffer(ppucDataPointer_, RC4_DBLK_DOPPLER_BITS[bIsSecondary]));
   if (iDopplerBitfield & RC4_DBLK_DOPPLER_SIGNBIT_MASK[bIsSecondary])
   {
      iDopplerBitfield |= RC4_DBLK_DOPPLER_SIGNEXT_MASK[bIsSecondary];
   }

   stDifferentialBlock_.bValidPSR        = iPSRBitfield != RC4_SIG_DBLK_INVALID_PSR;
   stDifferentialBlock_.dPSR             = static_cast<double>(iPSRBitfield) * RC4_SIG_BLK_PSR_SCALE_FACTOR + stReferenceBlock_.dPSR + (stReferenceBlock_.dDoppler * dSecondOffset_);
   stDifferentialBlock_.bValidPhaseRange = iPhaseRangeBitfield != RC4_SIG_DBLK_INVALID_PHASERANGE;
   stDifferentialBlock_.dPhaseRange      = static_cast<double>(iPhaseRangeBitfield) * RC4_SIG_BLK_PHASERANGE_SCALE_FACTOR + stReferenceBlock_.dPhaseRange + (stReferenceBlock_.dDoppler * dSecondOffset_);
...
//------------------------------------------------------------------------------
void
RangeDecompressor::PopulateNextRangeData(RangeDataStruct& stRangeData_, const RangeCmp4MeasurementSignalBlockStruct& stBlock_, const MetaDataStruct& stMetaData_, const ChannelTrackingStatusStruct& stChannelTrackingStatus_, uint32_t uiPRN_, char cGLONASSFrequencyNumber_)
{
   double dSignalWavelength = GetSignalWavelength(stChannelTrackingStatus_, static_cast<int16_t>(cGLONASSFrequencyNumber_ - GLONASS_FREQUENCY_NUMBER_OFFSET));
   ...
   case ChannelTrackingStatusStruct::SATELLITE_SYSTEM::GLONASS:
      ...
      stRangeData_.usPRN =
         (GLONASS_SLOT_UNKNOWN_LOWER_LIMIT <= uiPRN_ && uiPRN_ <= GLONASS_SLOT_UNKNOWN_UPPER_LIMIT) ? 0
         : static_cast<uint16_t>(uiPRN_) + GLONASS_SLOT_OFFSET - 1;
      break;
   case ChannelTrackingStatusStruct::SATELLITE_SYSTEM::SBAS:
      stRangeData_.usPRN =
           (SBAS_PRN_OFFSET_120_LOWER_LIMIT <= uiPRN_ && uiPRN_ <= SBAS_PRN_OFFSET_120_UPPER_LIMIT) ? static_cast<uint16_t>(uiPRN_ + SBAS_PRN_OFFSET_120 - 1)
         : (SBAS_PRN_OFFSET_130_LOWER_LIMIT <= uiPRN_ && uiPRN_ <= SBAS_PRN_OFFSET_130_UPPER_LIMIT) ? static_cast<uint16_t>(uiPRN_ + SBAS_PRN_OFFSET_130 - 1)
         : 0;
      break;
   case ChannelTrackingStatusStruct::SATELLITE_SYSTEM::QZSS:
   ...
   stRangeData_.dADR = stBlock_.bValidPhaseRange ? MAGIC_NEGATE * (stBlock_.dPhaseRange / dSignalWavelength) : std::numeric_limits<double>::quiet_NaN();
   stRangeData_.fADRStdDev = afTheRangeCmp4ADRStdDevValues[stBlock_.ucADRBitfield];
   stRangeData_.fDopplerFrequency = stBlock_.bValidDoppler ? static_cast<float>(MAGIC_NEGATE * (stBlock_.dDoppler / dSignalWavelength)) : std::numeric_limits<float>::quiet_NaN();
   stRangeData_.fCNo = stBlock_.fCNo;
   stRangeData_.fLockTime = DetermineRangeCmp4ObservationLocktime(stMetaData_, stBlock_.ucLockTimeBitfield, stChannelTrackingStatus_.eSatelliteSystem, stChannelTrackingStatus_.eSignalType, uiPRN_);
...
//------------------------------------------------------------------------------
void
RangeDecompressor::RangeCmpToRange(const RangeCmpStruct& stRangeCmpMessage_, RangeStruct& stRangeMessage_)
{
   ...
   for (uint32_t uiRangeDataIndex = 0; uiRangeDataIndex < stRangeMessage_.uiNumberOfObservations; uiRangeDataIndex++)
   {
      ...
      if (iTempDoppler & RC_DOPPLER_FREQUENCY_SIGNBIT_MASK)
      {
         iTempDoppler |= RC_DOPPLER_FREQUENCY_SIGNEXT_MASK;
      }
      stRangeData.fDopplerFrequency = static_cast<float>(iTempDoppler / RC_DOPPLER_FREQUENCY_SCALE_FACTOR);

      stRangeData.dPSR       = static_cast<double>(((stRangeCmpData.ulDopplerFrequencyPSRField & RC_PSR_MEASUREMENT_MASK) >> RC_PSR_MEASUREMENT_SHIFT)/RC_PSR_MEASUREMENT_SCALE_FACTOR);
      ...
      stRangeData.fADRStdDev = static_cast<double>((RC_ADR_STDDEV_SCALE_OFFSET+((stRangeCmpData.ucStdDevPSRStdDevADR & RC_ADR_STDDEV_MASK) >> RC_ADR_STDDEV_SHIFT))/RC_ADR_STDDEV_SCALE_FACTOR);
      ...
      stRangeData.sGLONASSFrequency = static_cast<int16_t>((stRangeCmpData.uiLockTimeCNoGLOFreq & RC_GLONASS_FREQUENCY_MASK) >> RC_GLONASS_FREQUENCY_SHIFT);
...
//------------------------------------------------------------------------------
void
RangeDecompressor::RangeCmp2ToRange(const RangeCmp2Struct& stRangeCmp2Message_, RangeStruct& stRangeMessage_, const MetaDataStruct& stMetaData_)
{
   ...
   {
      const auto& stRangeCmp2SatBlock = reinterpret_cast<const RangeCmp2SatelliteBlockStruct&>(stRangeCmp2Message_.aucRangeData[uiRangeDataBytesDecompressed]);

      // Decompress the Satellite Block
      const auto eSatelliteSystem = static_cast<SYSTEM>((stRangeCmp2SatBlock.ulCombinedField & RC2_SAT_SATELLITE_SYSTEM_ID_MASK) >> RC2_SAT_SATELLITE_SYSTEM_ID_SHIFT);
      const auto ucNumberOfSignalBlocks = static_cast<uint8_t>(static_cast<uint64_t>(stRangeCmp2SatBlock.ulCombinedField & RC2_SAT_NUM_SIGNAL_BLOCKS_BASE_MASK) >> RC2_SAT_NUM_SIGNAL_BLOCKS_BASE_SHIFT);

      // Extend the sign
      auto iPSRBase = static_cast<int32_t>(static_cast<uint64_t>(stRangeCmp2SatBlock.ulCombinedField & RC2_SAT_SATELLITE_PSR_BASE_MASK) >> RC2_SAT_SATELLITE_PSR_BASE_SHIFT);
      if (iPSRBase & RC2_SAT_SATELLITE_PSR_BASE_SIGNBIT_MASK)
      {
         iPSRBase |= RC2_SAT_SATELLITE_PSR_BASE_SIGNEXT_MASK;
      }

      // Extend the sign
      auto iDopplerBase = static_cast<int32_t>(static_cast<uint64_t>(stRangeCmp2SatBlock.ulCombinedField & RC2_SAT_SATELLITE_DOPPLER_BASE_MASK) >> RC2_SAT_SATELLITE_DOPPLER_BASE_SHIFT);
      if (iDopplerBase & RC2_SAT_SATELLITE_DOPPLER_BASE_SIGNBIT_MASK)
      {
         iDopplerBase |= RC2_SAT_SATELLITE_DOPPLER_BASE_SIGNEXT_MASK;
      }
      ...
      {
         const auto& stRangeCmp2SigBlock = reinterpret_cast<const RangeCmp2SignalBlockStruct&>(stRangeCmp2Message_.aucRangeData[uiRangeDataBytesDecompressed]);

         const auto eSignalType    = static_cast<RangeCmp2::SIGNAL_TYPE>(stRangeCmp2SigBlock.uiCombinedField1 & RC2_SIG_SIGNAL_TYPE_MASK);
         const auto ucPSRBitfield  = static_cast<uint8_t >((stRangeCmp2SigBlock.ulCombinedField2 & RC2_SIG_PSR_STDDEV_MASK) >> RC2_SIG_PSR_STDDEV_SHIFT);
         const auto ucADRBitfield  = static_cast<uint8_t >((stRangeCmp2SigBlock.ulCombinedField2 & RC2_SIG_ADR_STDDEV_MASK) >> RC2_SIG_ADR_STDDEV_SHIFT);
         const auto uiLocktimeBits = static_cast<uint32_t>((stRangeCmp2SigBlock.uiCombinedField1 & RC2_SIG_LOCKTIME_MASK)   >> RC2_SIG_LOCKTIME_SHIFT);
         const auto usPRN          = static_cast<uint16_t>(stRangeCmp2SatBlock.ucSatelliteIdentifier + (eSatelliteSystem == SYSTEM::GLONASS ? (GLONASS_SLOT_OFFSET - 1) : 0));

         // Extend the sign
         auto iDopplerBitfield = static_cast<int32_t>(static_cast<uint64_t>(stRangeCmp2SigBlock.ulCombinedField2 & RC2_SIG_DOPPLER_DIFF_MASK) >> RC2_SIG_DOPPLER_DIFF_SHIFT);
         if (iDopplerBitfield & RC2_SIG_DOPPLER_DIFF_SIGNBIT_MASK)
         {
            iDopplerBitfield |= RC2_SIG_DOPPLER_DIFF_SIGNEXT_MASK;
         }

         const auto fPSRDiff           = static_cast<float>((stRangeCmp2SigBlock.ulCombinedField2 & RC2_SIG_PSR_DIFF_MASK) >> RC2_SIG_PSR_DIFF_SHIFT);
         const auto fPhaseRangeDiff    = static_cast<float>(static_cast<uint64_t>(stRangeCmp2SigBlock.ulCombinedField2 & RC2_SIG_PHASERANGE_DIFF_MASK) >> RC2_SIG_PHASERANGE_DIFF_SHIFT);
         ...
         stRangeData.dADR = MAGIC_NEGATE * (static_cast<double>(iPSRBase) + static_cast<double>(fPhaseRangeDiff/RC2_SIG_PHASERANGE_DIFF_SCALE_FACTOR)) / (GetSignalWavelength(stChannelTrackingStatus, (stRangeData.sGLONASSFrequency-GLONASS_FREQUENCY_NUMBER_OFFSET)));
         stRangeData.fADRStdDev = afTheRangeCmp2ADRStdDevValues[ucADRBitfield];
         stRangeData.fDopplerFrequency = static_cast<float>(iDopplerBase + fScaledDopplerDiff) / static_cast<float>(mmTheRangeCmp2SignalScalingMapping[eSatelliteSystem][eSignalType]);
         stRangeData.fCNo = RC2_SIG_CNO_SCALE_OFFSET + static_cast<float>(stRangeCmp2SigBlock.ulCombinedField2 & RC2_SIG_CNO_MASK);
         stRangeData.fLockTime = DetermineRangeCmp2ObservationLocktime(stMetaData_, uiLocktimeBits, stChannelTrackingStatus.eSatelliteSystem, stChannelTrackingStatus.eSignalType, usPRN);
...
//------------------------------------------------------------------------------
void
RangeDecompressor::RangeCmp4ToRange(uint8_t* pucCompressedData_, RangeStruct& stRangeMessage_, const MetaDataStruct& stMetaData_)
{
   ...
   if (dSecondOffset == 0.0)
   {
      ammmMyReferenceBlocks[static_cast<uint32_t>(eMeasurementSource)].clear();
   }
   ...
   // We have to set uiMyBytesRemaining by typecasting because GetBitfieldFromBuffer() relies on it.
   ...
   // For each satellite system, we will decode a series of measurement block headers, each with their
   // own subsequent reference signal measurement blocks.
   for (uint8_t ucSystemIndex = 0; ucSystemIndex < RC4_HEADER_BLOCK_SYSTEM_COUNT; ucSystemIndex++)
   {
      ...
      if (usSatelliteSystems & (1UL << static_cast<uint16_t>(eCurrentSatelliteSystem)))
      {
         ...
         {
            if (usSignals & (1UL << static_cast<uint16_t>(eCurrentSignalType)))
            {
               vSignals.push_back(eCurrentSignalType);
            }
         }
         ...
         for (const auto& uiPRN : vPRNs)
         {
            ...
            stMeasurementBlockHeader.bIsDifferentialData = static_cast<bool>(GetBitfieldFromBuffer(&pucTempDataPointer, RC4_MBLK_HDR_DATAFORMAT_FLAG_BITS));
            stMeasurementBlockHeader.ucReferenceDataBlockID = static_cast<uint8_t>(GetBitfieldFromBuffer(&pucTempDataPointer, RC4_MBLK_HDR_REFERENCE_DATABLOCK_ID_BITS));
            ...
            {
               stMeasurementBlockHeader.cGLONASSFrequencyNumber = static_cast<uint8_t>(GetBitfieldFromBuffer(&pucTempDataPointer, RC4_MBLK_HDR_GLONASS_FREQUENCY_NUMBER_BITS));
            }
            ...
            for (RangeCmp4::SIGNAL_TYPE eCurrentSignalType : vSignals)
            {
               ...
               if (ulIncludedSignals & (1ULL << uiSignalBitMaskShift++))
               {
                  if (!stMeasurementBlockHeader.bIsDifferentialData) // This is a reference block.
                  {
                     ...
                     {
                        DecompressReferenceBlock<true>(&pucTempDataPointer, stMeasurementBlock, eMeasurementSource);
                     }

                     stChannelTrackingStatus = ChannelTrackingStatusStruct(eCurrentSatelliteSystem, eCurrentSignalType, stMeasurementBlock);
                     PopulateNextRangeData((stRangeMessage_.astRangeData[stRangeMessage_.uiNumberOfObservations++]), stMeasurementBlock, stMetaData_, stChannelTrackingStatus, uiPRN, stMeasurementBlockHeader.cGLONASSFrequencyNumber);

                     // Always store reference blocks.
                     ammmMyReferenceBlocks[static_cast<uint32_t>(eMeasurementSource)][eCurrentSatelliteSystem][eCurrentSignalType][uiPRN] = std::pair(stMeasurementBlockHeader, stMeasurementBlock);
                  }
                  else // This is a differential block.
                  {
                     ...
                     try
                     {
                        pstReferenceBlockHeader = &ammmMyReferenceBlocks[static_cast<uint32_t>(eMeasurementSource)].at(eCurrentSatelliteSystem).at(eCurrentSignalType).at(uiPRN).first;
                        pstReferenceBlock       = &ammmMyReferenceBlocks[static_cast<uint32_t>(eMeasurementSource)].at(eCurrentSatelliteSystem).at(eCurrentSignalType).at(uiPRN).second;
                     }
                     catch(...)
                     {
                        pclMyLogger->warn("No reference data exists for SATELLITE_SYSTEM {}, SIGNAL_TYPE {}, PRN {}, ID {}", static_cast<int32_t>(eCurrentSatelliteSystem), static_cast<int32_t>(eCurrentSignalType), uiPRN, stMeasurementBlockHeader.ucReferenceDataBlockID);
                     }
                     ...
                     if (pstReferenceBlockHeader != nullptr && pstReferenceBlock != nullptr)
                     {
                        if (stMeasurementBlockHeader.ucReferenceDataBlockID == pstReferenceBlockHeader->ucReferenceDataBlockID)
                        {
                           if (bPrimaryBlock)
                           {
                              DecompressDifferentialBlock<false>(&pucTempDataPointer, stMeasurementBlock, *pstReferenceBlock, dSecondOffset);
                              bPrimaryBlock = false;
                           }
                           else
                           {
                           ...
                           stChannelTrackingStatus = ChannelTrackingStatusStruct(eCurrentSatelliteSystem, eCurrentSignalType, stMeasurementBlock);
                           PopulateNextRangeData(stRangeMessage_.astRangeData[stRangeMessage_.uiNumberOfObservations++], stMeasurementBlock, stMetaData_, stChannelTrackingStatus, uiPRN, pstReferenceBlockHeader->cGLONASSFrequencyNumber);
                        }
                        else
                        {
                           pclMyLogger->warn("Invalid reference data: Diff ID {} != Ref ID {}",
                              static_cast<uint32_t>(stMeasurementBlockHeader.ucReferenceDataBlockID), static_cast<uint32_t>(pstReferenceBlockHeader->ucReferenceDataBlockID));
                        }
                     }
                  }

                  // Keep track of how many signals came from this PRN so we can go back and alter the message fields we cannot know
                  // until some time in the future.
                  uiSignalsForPRN++;
               }
            }

            // Go back and update the grouping bit in the status word if we've counted more than one signal for this PRN.  We can't know this
            // ahead of time without blindly jumping forward into the compressed message.
...
//------------------------------------------------------------------------------
STATUS
RangeDecompressor::Decompress(
   unsigned char* pucRangeMessageBuffer_,
   uint32_t uiRangeMessageBufferSize_,
   MetaDataStruct& stMetaData_,
   ENCODEFORMAT eFormat_)
{
   // Check for buffer validity
   if (!pucRangeMessageBuffer_)
   {
   ...
   if (!clMyRangeCmpFilter.DoFiltering(stMetaData_))
   {
   ...
   if (eInitialFormat != HEADERFORMAT::BINARY)
   {
      ...
      eStatus = clMyEncoder.Encode(&pucRangeMessageBuffer_, uiRangeMessageBufferSize_, stHeader, stMessage, stMessageData, stMetaData_, ENCODEFORMAT::FLATTENED_BINARY);
      if (eStatus != STATUS::SUCCESS)
      {
         return eStatus;
      }
   ...
   {
      eFormat_ =
           (eInitialFormat == HEADERFORMAT::BINARY || eInitialFormat == HEADERFORMAT::SHORT_BINARY || eInitialFormat == HEADERFORMAT::PROPRIETARY_BINARY) ? ENCODEFORMAT::BINARY
         : (eInitialFormat == HEADERFORMAT::ASCII  || eInitialFormat == HEADERFORMAT::SHORT_ASCII  || eInitialFormat == HEADERFORMAT::ABB_ASCII)          ? ENCODEFORMAT::ASCII
