...
void init_common_jsonreader(nb::module_& m)
{
    ...
    nb::class_<BaseField>(m, "BaseField", "Struct containing elements of basic fields in the UI DB")
        ...
        .def("__repr__", [](const BaseField& field) {
            ...
            ss << field.conversion << ", ";
            ss << nb::str(nb::cast(field.conversionStripped)).c_str() << ", ";
    ...
    nb::class_<JsonReader>(m, "JsonReader")
        ...
        .def("remove_message", &JsonReader::RemoveMessage<const std::string&>, "file_path"_a, "generate_mappings"_a = true)
        .def("remove_enumeration", &JsonReader::RemoveEnumeration<const std::string&>, "file_path"_a, "generate_mappings"_a = true)
