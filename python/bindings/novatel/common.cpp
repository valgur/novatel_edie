...
void init_novatel_common(nb::module_& m)
{
   ...
   nb::class_<oem::MessageDataStruct>(m, "MessageDataStruct")
      .def(nb::init<>())
      .def_prop_ro("message_header", [](oem::MessageDataStruct& self) {
         return nb::bytes((char*) self.pucMessageHeader, self.uiMessageHeaderLength);
      })
      .def_prop_ro("message_body", [](oem::MessageDataStruct& self) {
         return nb::bytes((char*) self.pucMessageBody, self.uiMessageBodyLength);
      })
      .def_prop_ro("message", [](oem::MessageDataStruct& self) {
         return nb::bytes((char*) self.pucMessage, self.uiMessageLength);
      });
