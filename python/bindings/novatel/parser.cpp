...
void init_novatel_parser(nb::module_& m)
{
   nb::class_<oem::Parser>(m, "Parser")
      ...
      .def_prop_rw("decompress_range_cmp", &oem::Parser::GetDecompressRangeCmp,
                   &oem::Parser::SetDecompressRangeCmp)
      .def_prop_rw("return_unknown_bytes", &oem::Parser::GetReturnUnknownBytes,
                   &oem::Parser::SetReturnUnknownBytes)
      ...
      .def("write", [](oem::Parser& self, nb::bytes data) {
      ...
      .def("flush", [](oem::Parser& self, bool return_flushed_bytes) -> nb::object {
         ...
         char buffer[oem::Parser::uiPARSER_INTERNAL_BUFFER_SIZE];
         uint32_t count = self.Flush((unsigned char*) buffer, oem::Parser::uiPARSER_INTERNAL_BUFFER_SIZE);
         return nb::bytes(buffer, count);
      }, "return_flushed_bytes"_a = false)
      .def_prop_ro("internal_buffer", [](oem::Parser& self) {
         return nb::bytes((char*) self.GetInternalBuffer(), oem::Parser::uiPARSER_INTERNAL_BUFFER_SIZE);
      });
}
