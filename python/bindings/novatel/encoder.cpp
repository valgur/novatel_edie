...
void init_novatel_encoder(nb::module_& m)
{
    nb::class_<oem::Encoder>(m, "Encoder")
        ...
        .def(
            "encode",
            [](oem::Encoder& encoder, oem::IntermediateHeader& header, novatel::edie::IntermediateMessage& message,
               novatel::edie::MessageDataStruct& message_data, oem::MetaDataStruct& metadata, ENCODEFORMAT format) {
