...
void init_novatel_fileparser(nb::module_& m)
{
   nb::class_<oem::FileParser>(m, "FileParser")
      ...
      .def_prop_rw("decompress_range_cmp", &oem::FileParser::GetDecompressRangeCmp,
                   &oem::FileParser::SetDecompressRangeCmp)
      ...
      .def("read", [](oem::FileParser& self, nb::handle_t<oem::MetaDataStruct> py_metadata) {
         oem::MessageDataStruct message_data;
      ...
      .def_prop_ro("internal_buffer", [](oem::FileParser& self) {
