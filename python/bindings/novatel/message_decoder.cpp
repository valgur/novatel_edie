...
nb::object convert_field(const novatel::edie::FieldContainer& field)
{
    ...
    {
        const auto& message_field = std::get<novatel::edie::IntermediateMessage>(field.fieldValue);
...
void init_novatel_message_decoder(nb::module_& m)
{
    ...
    nb::class_<novatel::edie::FieldContainer>(m, "FieldContainer")
        ...
        .def_rw("field_def", &novatel::edie::FieldContainer::fieldDef, nb::rv_policy::reference_internal)
