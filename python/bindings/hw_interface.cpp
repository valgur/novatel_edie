...
public:
   ...
   std::u32string Get32ExtensionName() { return s32MyExtentionName; }
};
...
//      .def_prop_ro("file_stream", &FileStream::GetMyFileStream)
   ...
   nb::class_<MultiOutputFileStream>(m, "MultiOutputFileStream")
      ...
      // For unit tests only
      .def_prop_ro("_base_name", [](MultiOutputFileStream& self) {
         return static_cast<MultiOutputFileStreamTest*>(&self)->GetBase32FileName();
      })
      .def_prop_ro("_extension_name", [](MultiOutputFileStream& self) {
         return static_cast<MultiOutputFileStreamTest*>(&self)->Get32ExtensionName();
      });
